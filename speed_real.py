...
if __name__ == "__main__":
    ...
    net = parsingNet(pretrained = False, backbone='18',det_dim = (100+1,56,4),use_aux=False).cuda()
    # net = parsingNet(pretrained = False, backbone='18',det_dim = (200+1,18,4),use_aux=False).cuda()
    net.eval()
